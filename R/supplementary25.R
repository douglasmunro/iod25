...
#'
#'
#' @format A tibble with 67,510 rows and 8 variables:
#' \describe{
...
#'   \item{index}{Deprivation Index}
#'   \item{rank}{Index Rank (where 1 is most deprived)}
#'   \item{decile}{Index Decile (where 1 is most deprived 10% of LSOAs)}
#'   \item{score}{Index Score}
#' }
