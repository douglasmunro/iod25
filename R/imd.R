...
#'   \item{imd_rank}{Index of Multiple Deprivation (IMD) Rank (where 1 is most deprived)}
#'   \item{imd_decile}{Index of Multiple Deprivation (IMD) Decile (where 1 is most deprived 10% of LSOAs)")}
#' }
